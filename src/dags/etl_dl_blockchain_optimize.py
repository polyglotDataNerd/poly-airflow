...
dag = DAG(
    dag_id='etl_dl_blockchain_optimize',
    ...
    tags=["data-platform", "blockchain", "kafka", "ethereum"]
)
...
SPARK_STEPS = [
    {
        'Name': 'Etherum Silver Tables Compaction',
        'ActionOnFailure': 'TERMINATE_CLUSTER',
        'HadoopJarStep': {
            'Jar': 's3://us-west-2.elasticmapreduce/libs/script-runner/script-runner.jar',
            'Args': ['s3://poly-data-utils/scripts/shell/run_compaction.sh'],
        },
    }
]
...
JOB_FLOW_OVERRIDES = {
    ...
    'Tags': [
        ...
        {
            'Key': 'Description',
            'Value': 'Blockchain Tables Optimization'
        },
        {
            'Key': 'Team',
            'Value': 'Data'
