...
aws s3 cp s3://bigdata-utility/terraform/airflow/infra/$environment/$CURRENTDATE ~/solutions/zib-airflow/infrastructure/serviceinfra  --recursive --sse --quiet --include "*"
...
cd ~/solutions/zib-airflow/infrastructure/serviceinfra
terraform init
terraform get
terraform plan
...
aws s3 cp ~/solutions/zib-airflow/infrastructure/serviceinfra/ s3://bigdata-utility/terraform/airflow/infra/$environment/$CURRENTDATE/  --recursive --sse --quiet --exclude "*" --include "*terraform.tfstate*"
